...
let salarioMinimo = [
    ...
    {ano: 2021, salario: 1.100 },
    {ano: 2022, salario: 1.212},
    {ano: 2023, salario: 1.302},
];
...
console.log("2 - Listar o índice IPCA de 2010 á 2023");
...
let crescimentoLabel = "Crescimento Salerial: ";
...
switch(escolha) 
{
    case 1:
        for(let i = 0; i <= salarioMinimo.length-1; i++) 
        {
            ...
            let salrioFormatado = salario.toFixed(2).replace(".",".",".");

            console.log("\n");
            console.log(anoLabel+ano);
            console.log(salarioLabel+"R$"+salrioFormatado);
